  ...
  head: () => ({
    meta: [
      { title: "املاک — از فایل معتبر تا قرارداد امن" },
      {
        name: "description",
        content:
          "پلتفرم امن رهن و اجاره مسکونی در تهران و کرج؛ فایل تأییدشده، پرداخت امن و قرارداد یکپارچه.",
      },
      {
        property: "og:title",
        content: "املاک — از فایل معتبر تا قرارداد امن",
      },
      {
        property: "og:description",
        content:
          "کشف فایل معتبر، نوبت‌دهی، مذاکره ساختاریافته و پرداخت دو مرحله‌ای.",
      },
    ],
  }),
  component: HomePage,
